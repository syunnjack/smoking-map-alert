...
const saveKey = 'smoking-map-alert.saved'
const postKey = 'smoking-map-alert.posts'
const alerts = [
  {
    "id": "smoking-map-alert-1",
    "title": "喫煙所 alert seed 1",
    "area": "名古屋",
    "category": "喫煙所",
    "score": 95,
    "summary": "喫煙所の新設、閉鎖、喫煙可飲食店を通知し、飲食店送客、掲載課金、マップ広告へつなげる。 喫煙所の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  {
    "id": "smoking-map-alert-2",
    "title": "喫煙可 alert seed 2",
    "area": "東京",
    "category": "喫煙可",
    "score": 92,
    "summary": "喫煙所の新設、閉鎖、喫煙可飲食店を通知し、飲食店送客、掲載課金、マップ広告へつなげる。 喫煙可の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
  ...
  {
    "id": "smoking-map-alert-3",
    "title": "閉鎖 alert seed 3",
    "area": "大阪",
    "category": "閉鎖",
    "score": 89,
    "summary": "喫煙所の新設、閉鎖、喫煙可飲食店を通知し、飲食店送客、掲載課金、マップ広告へつなげる。 閉鎖の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "smoking-map-alert-4",
    "title": "新設 alert seed 4",
    "area": "静岡",
    "category": "新設",
    "score": 86,
    "summary": "喫煙所の新設、閉鎖、喫煙可飲食店を通知し、飲食店送客、掲載課金、マップ広告へつなげる。 新設の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">喫煙所・喫煙可店舗の新規/閉鎖通知</p>
          <h1>Smoking Map Alert</h1>
